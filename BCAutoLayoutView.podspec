#
#  Be sure to run `pod spec lint BCAutoLayoutView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "ustbenchan"
  # s.authors            = { "ustbenchan" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/ustbenchan/BCAutoLayoutView.git", :tag => "v0.0.1" }
  ...
  s.source_files  = "Classes", "BCAutoLayoutView/sources/**/*.{h,m}"
